...
RSpec.describe Book, type: :model do
  describe "書籍登録" do
    context "書籍を新たに登録するとき" do
      it "正しく登録できるとき" do
        new_book = build(:test_book)
        # isbn不要でも登録可能
        isbn_blank_book = build(:test_book, isbn: "")
      ...
      it "正しく登録できないとき" do
        name_blank_book = build(:test_book, book_name: "")
